...
Code for the study of kinship knowledge acquisition in Datooga children across three villages (Eshkesh, Garawja, Getanyamba). Children (n = 65) were asked a series of questions testing genealogical knowledge, kin-term recognition, allocentric kinship reasoning, and perspective reversal.
...
```
data/
  kinship_interview_data.xlsx          raw interview data (Results, Metadata, Genealogical sheets)
  Q5_kin_category_list_order*.xlsx     kin category ordering for section 4 preference analysis
  merged_data.csv                      cleaned merged data (generated by make clean_data)
  merged_data_wIndex.csv               same with education_index column pre-computed
